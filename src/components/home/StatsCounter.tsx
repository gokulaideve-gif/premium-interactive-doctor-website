...
function Counter({ end, suffix = "", duration = 2000 }: { end: number; suffix?: string; duration?: number }) {
  ...
  return (
    <div ref={ref} className="text-3xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-cyan-600 to-teal-600 bg-clip-text text-transparent">
      {count}{suffix}
    </div>
  );
}
...
const stats = [
  ...
  { icon: Award, value: 15, suffix: "+", label: "Years Experience", color: "from-amber-400 to-orange-500" },
...
export default function StatsCounter() {
  return (
    <section className="relative py-24 bg-gradient-to-br from-slate-900 to-slate-800 dark:from-slate-950 dark:to-slate-900 overflow-hidden">
      {/* Background Pattern */}
