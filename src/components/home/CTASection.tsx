...
export default function CTASection() {
  return (
    <section className="relative py-24 lg:py-32 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-cyan-500 via-teal-400 to-blue-600" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="text-lg text-white/80 mb-10 max-w-2xl mx-auto">
            Schedule your appointment today and experience premium healthcare with our expert medical team.
          </p>
        </motion.div>
        ...
        >
          <Link
            href="/booking"
            className="group inline-flex items-center gap-2 px-8 py-4 bg-white text-slate-900 font-semibold rounded-full hover:shadow-xl hover:shadow-black/10 transition-all duration-300"
          >
