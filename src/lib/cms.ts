...
export const cmsDefaults: CmsFieldDefinition[] = [
  ...
  { page: "home", key: "stats.experience.label", label: "Experience label", value: "Year Excellence", valueType: "text", groupName: "Opening statistics", sortOrder: 41 },
  { page: "home", key: "stats.patients.value", label: "Patient value", value: "5000+", valueType: "text", groupName: "Opening statistics", sortOrder: 42 },
  ...
  { page: "home", key: "stats.access.value", label: "Access value", value: "1", valueType: "text", groupName: "Opening statistics", sortOrder: 46 },
  { page: "home", key: "stats.access.label", label: "Access label", value: "Clinic Centre", valueType: "text", groupName: "Opening statistics", sortOrder: 47 },
