...
export const cmsDefaults: CmsFieldDefinition[] = [
  ...
  { page: "global", key: "contact.email", label: "Email address", value: "care@drrudrawellness.com", valueType: "text", groupName: "Contact", sortOrder: 11 },
  ...
  { page: "home", key: "hero.title", label: "Main opening title", value: "DR. RUDRA", valueType: "text", groupName: "Opening page", sortOrder: 21 },
  ...
  { page: "home", key: "hero.secondaryCta", label: "Secondary button text", value: "Meet Dr. Rudra", valueType: "text", groupName: "Opening page", sortOrder: 25 },
  { page: "home", key: "hero.doctorImage", label: "Main doctor photo", value: "/images/doctor-doll.png", valueType: "image", groupName: "Opening media", sortOrder: 30 },
  { page: "home", key: "hero.mascotImage", label: "Animated doctor doll", value: "/images/doctor-doll.png", valueType: "image", groupName: "Opening media", sortOrder: 31 },
  { page: "home", key: "hero.photoLabel", label: "Doctor photo caption", value: "Personalised wellness, thoughtfully delivered", valueType: "text", groupName: "Opening media", sortOrder: 32 },
  ...
  { page: "home", key: "achievements.description", label: "Achievements introduction", value: "New qualifications, research, awards and moments from Dr. Rudra’s continuing wellness journey.", valueType: "textarea", groupName: "Achievements section", sortOrder: 52 },
];
